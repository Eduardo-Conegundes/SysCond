...
public class UsuarioViewController implements Initializable{
	...
	/**
	 * 
	 * @param--> recebe como paramentro event do tipo MouseEvent, para que seja efetuado a sele��o do Usuario que deseja-se editar ao ser cliclar..
	 */
	@FXML
...
//		this.txfId.setText(Integer.toString(select.get(0).getId()));
	...
	/**
	 * 
	 * @param--> recebe como paramentro event do tipo MouseEvent, para que seja efetuado a sele��o do Usuario que deseja-se excluir ao ser cliclar..
	 */
	@FXML
