...
import static Models.Pessoa_.nome;
...
public class Syscond {
    ...
    public static void main(String[] args) {
        ...
        //######## SALVAR EMPRESA ########
        Empresa E = new Empresa("12345", l, "Salvese", "alimento", "14456");
        ...
        //######## SALVAR LOCAÇÃO ########
        Locacao L = new Locacao(j, Es, (float)500.00);
